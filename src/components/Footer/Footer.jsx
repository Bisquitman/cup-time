    ...
    <footer className="footer">
      <div className="container footer__container">
        <a className="footer__logo-link">
          <img className="footer__logo" src="/img/logo.svg" alt="Logo cup time" />
        </a>

        <div className="footer__nav">
          <ul className="footer__menu">
            <li className="footer__menu-item">
              <a className="footer__menu-link active" href="#">
                Чай
              </a>
            </li>
        ...
        <div className="footer__info">
          ...
          <p className="footer__description" hidden>
          ...
          <ul className="footer__developers">
            <li className="footer__developer">
              Designer:{" "}
              <a className="footer__developer-link" href="#" target="_blank" rel="noreferrer noopener">
                Anastasia Ilina
              </a>
            </li>
            <li className="footer__developer">
